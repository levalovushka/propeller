...
CLERICAL = [
    ...
    r"\bданн(?:ый|ая|ое|ые|ого|ой|ых)\b", r"\bявляет\w*\b", r"\bосуществля\w+\b",
...
DEADLINE_STEMS = {
    ...
    "сегодня вечером": "вечер", "к вечеру": "вечер", "к утру": "утр",
    "до конца месяца": "месяц",
}
...
CHECKS = [
    "срок не из транскрипта", "ответственный-призрак", "имя не из транскрипта", "число не из транскрипта", "латиница не из транскрипта", "таймкод за пределами встречи",
...
SHORT = {
    "срок не из транскрипта": "срок!", "ответственный-призрак": "кто?",
