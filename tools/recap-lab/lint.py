...
CHECKS = [
    "срок не из транскрипта", "повелительное наклонение", "ответственный-призрак", "имя не из транскрипта", "число не из транскрипта", "латиница не из транскрипта", "таймкод за пределами встречи",
...
SHORT = {
    "срок не из транскрипта": "срок!", "повелительное наклонение": "приказ", "ответственный-призрак": "кто?",
