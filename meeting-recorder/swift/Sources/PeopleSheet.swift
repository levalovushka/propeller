...
/// Shared duration formatter for people/sample views.
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            HStack(alignment: .top, spacing: 14) {
                ...
                VStack(alignment: .leading, spacing: 4) {
                    ...
                    HStack(spacing: 10) {
                        ...
                        statBadge(label: "Voice", value: compactDuration(person.totalDuration))
            ...
            HStack {
                Text("Voice Samples")
                    ...
                    .foregroundStyle(.secondary)
                Spacer()
                Text("\(person.sampleCount) · \(compactDuration(person.totalDuration))")
                    .font(.caption2)
                    .foregroundStyle(.tertiary)
            }
            .padding(.horizontal, 20)
