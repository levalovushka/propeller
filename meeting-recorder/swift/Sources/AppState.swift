...
class AppState: ObservableObject {
    ...
    private func beginRecording() {
        ...
        do {
            ...
            let placeholder = MeetingTitle.placeholder(
                stamp: DateFormatter.localizedString(from: now, dateStyle: .short, timeStyle: .short)
            )
    ...
    private func generateMeetingMetadata(recordingID: String, summary: String) async {
        ...
        let needTitle = MeetingTitle.isPlaceholder(rec.title) && rec.titleManuallySet != true
