...
public enum Tokens {
    ...
    public enum Pane {
        ...
        /// Как поле оживает и как оно растёт.
        ///
        /// Плита под ним поднимается и опускается на тех же ступенях, что у
        /// панели действий (`Bar.fadeIn` / `fadeOut`): это один и тот же
        /// предмет — вызванный инструмент, — и появляться по-разному в двух
        /// местах он не может.
        ///
        ...
        public enum NoteBar {
            public static let raise = Motion.Step.t120
            public static let lower = Motion.Step.t90
