...
final class MotionScaleTests: XCTestCase {
    ...
    func testEveryDurationIsAStepOnTheLadder() {
        let named: [(String, Double)] = [
            ...
            ("Motion.windowResize", Tokens.Motion.windowResize),
            ("Motion.notesButtonFade", Tokens.Motion.notesButtonFade),
            ("Motion.notesInkFade", Tokens.Motion.notesInkFade),
            ("Motion.notesInkDelay", Tokens.Motion.notesInkDelay),
            ("Motion.notesInkLead", Tokens.Motion.notesInkLead),
