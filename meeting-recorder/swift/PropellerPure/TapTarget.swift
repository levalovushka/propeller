...
///
/// # Почему это правило отдельное
///
/// До 2026-07-29 на вопрос «звук какого приложения мы имеем право писать»
/// отвечала `CaptureScopePolicy` — в bundle id, потому что ScreenCaptureKit
/// фильтруется приложениями. Она удалена вместе с SCK; здесь остался тот же
/// вопрос, заданный Core Audio.
///
