...
Инженерный слой (ленивый ASR-sidecar, timer coalescing, поллинг Zoom, Core Audio taps, тесты) вынесен в отдельный трек — см. [`../../plan-optimization.md`](../../archive/plan-optimization.md).
